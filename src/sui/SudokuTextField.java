...
public class SudokuTextField extends TextField
{
    ...
    public boolean hasLeftBorderShown() { return hasLeftBorder; }
    public boolean hasRightBorderShown() { return hasRightBorder; }
    public boolean hasTopBorderShown() { return hasTopBorder; }
    public boolean hasBottomBorderShown() { return hasBottomBorder; }
    
    /**
     * This method set values to indicate which of the outer edges of the textField
     * frame include a border, and sets the uniform thickness of that border for
     * all areas that have one. 
     * @param top An integer greater than zero indicates the presence of a border.
     * @param right An integer greater than zero indicates the presence of a border.
     * @param bottom An integer greater than zero indicates the presence of a border.
     * @param left An integer greater than zero indicates the presence of a border.
     * @param borderThickness An integer indicates the width of border.  Zeroes or
     * negatives are theoretically allowed since only non-zeroes will yield a 
     ...
     * or negatives are theoretically allowed since only non-zeroes will yield  
     * a display border because all border booleans will be false otherwise.
     */
